...
#toto dát nakonec a najednou nastavit anchor pro všechny obrázky
for meteor_size in (meteor_big_pngs, meteor_med_pngs, meteor_small_pngs):
    for png in meteor_size:
        png.anchor_x = png.width // 2
        png.anchor_y = png.height // 2
